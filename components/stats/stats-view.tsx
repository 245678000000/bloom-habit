    ...
    <div className="space-y-4 pb-8 md:space-y-5">
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
        <Card>
          <CardContent className="flex items-center gap-3 py-5">
            <Trophy className="h-5 w-5 shrink-0 text-[#ef9c62]" />
            <div>
        ...
        <Card>
          <CardContent className="flex items-center gap-3 py-5">
            <Target className="h-5 w-5 shrink-0 text-[#86b69d]" />
            <div>
        ...
        <Card>
          <CardContent className="flex items-center gap-3 py-5">
            <CalendarCheck2 className="h-5 w-5 shrink-0 text-[#b89ed3]" />
            <div>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-12">
        ...
        <Card className="lg:col-span-5">
          ...
          <CardContent>
            <div className="flex h-52 items-end gap-2 rounded-3xl bg-white/55 p-4 dark:bg-[#223028]/72 md:h-64">
              {trend.map((item) => (
